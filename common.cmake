...
if(NOT DEFINED CC_STATIC_RUNTIME)
    ...
    if((CMAKE_HOST_LINUX OR CMAKE_HOST_APPLE) AND static_runtime_default_value)
        message(STATUS "Cannot link to the GNU C Library or BSD libc (which are assumed) statically, going to link dynamically")
        set(static_runtime_default_value OFF)
    endif()
