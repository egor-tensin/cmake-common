...
if(NOT DEFINED CC_STATIC_RUNTIME)
    set(cc_static_runtime_default "${default_value}")
    if(UNIX)
        set(cc_static_runtime_default OFF)
    endif()
    option(CC_STATIC_RUNTIME "Link the runtime statically" "${cc_static_runtime_default}")
endif()
